...
export default function Prompts() {
  ...
  const promptCard2 = {
    ...
    text3: 'Retrato en primer plano de @Yo como un superhéroe, increíblemente poderoso, con un traje de alta tecnología y colores vibrantes. Pose heroica, expresión determinada, rodeado de energía y efectos especiales. Arte inspirado en los cómics de Marvel y DC, con estilo de Jim Lee, Alex Ross y Todd McFarlane.',
  };
  const promptCard3 = {
    ...
    text3: ' Retrato detallado de cerca de @mi como astronauta, futurista, altamente detallado, ultra realista, arte conceptual, texturas intrincadas, fondo interestelar, viaje espacial, arte por Alphonse Mucha, Ryan Kittleson, Greg Rutkowski, Leesha Hannigan, Stephan Martiniere, Stanley Artgerm Lau.',
  };
  const promptCard4 = {
  ...
  const promptCard6 = {
    ...
    text3: ' Retrato detallado de cerca de @mi como un payaso, altamente detallado, surrealista, rostro inexpresivo, colores brillantes, iluminación contrastante, fondo abstracto, arte de wlop, Greg Rutkowski, Charlie Bowater, Magali Villeneuve, Alphonse Mucha, estilo caricaturesco, inspirado en cómics.',
  };
  // const promptCard = {
  //   img: '',
  //   text1: '',
  ...
  return (
    <div>
      ...
      <div className="Astronauta my-1" onClick={() => handleCopy(promptCard3.text3)}>
       <div className="float-right">
            <Image
              src={promptCard3.img}
              alt=""
     ...
     <a
      ...
      <div className="Hobbit1 my-1"  onClick={() => handleCopy(promptCard5.text3)}>
      <div className="float-right">
            <Image
              src={promptCard5.img}
              alt=""
      ...
      <div className="Payaso my-1" onClick={() => handleCopy(promptCard6.text3)}>
      <div className="float-right">
            <Image
              src={promptCard6.img}
              alt=""
